...
<div class="flex items-center space-x-4">
    ...
    <div class="relative group">
        ...
        <div class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-lg py-2 hidden group-hover:block z-50">
            ...
            <form method="POST" action="<?php echo e(route('admin.logout')); ?>" class="border-t border-gray-200 dark:border-gray-700 mt-2 pt-2">
                <?php echo csrf_field(); ?>
...
</div><?php /**PATH /var/www/html/resources/views/admin/layouts/partials/header.blade.php ENDPATH**/ ?>